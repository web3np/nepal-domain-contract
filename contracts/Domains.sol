...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) ERC721 ("Web3 Nepal Name Service", "WNS") payable {
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the Web3 Nepal Name Service", "image": "data:image/svg+xml;base64,',
  ...
  function price(string calldata name) public pure returns(uint) {
    ...
    if (len == 3) {
      ...
      return 2 * 10**17; // To charge smaller amounts, reduce the decimals. This is 0.2
    } else {
      return 1 * 10**17;
    }
  }
